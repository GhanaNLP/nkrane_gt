...
Nkrane - Google Translate (nkrane-gt) is a Python library that enhances the googletrans python library with terminology control for low-resource languages, with a focus on Ghanaian and languages.
